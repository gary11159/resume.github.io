            ...
            <section>
                <div id="experience" className="parallax_3">
                    ...
                    <Container id="con" className="padding-50">
                        {/* 名子 */}
                        <Row id="row_1" style={props.device !== "PC" ? {marginBottom : '5vh'} : null}>
                            <Col id="exp1" md={6} className={props.device === 'PC' ? "right" : ""}>
                                <ScrollAnimation animateIn="fadeInUp" animateOut="fadeOut" animateOnce={true}>
                                    <Container className={"containerHeight" + (props.device === 'PC' ? " exContainerR" : "")}>
                                        <p className="font_7">
                                            2019/03 - 2019/08
                                            {props.device === "PC" &&
                                        ...
                                        <br></br>
                                        <span className={props.device === "PC" ? "sp-Right" : "sp"}>
                                            中大型專案，專案人數7~15人，擔任軟體工程師職位<br />
                                            壓力測試 - 負責整個專案的壓力測試<br />
                        ...
                        <Row style={props.device !== "PC" ? {marginBottom : '5vh'} : null}>
                            <Col md={6}>
                            </Col>
                            <Col id="exp2" md={6} className={props.device === 'PC' ? "left" : ""}>
                                <ScrollAnimation animateIn="fadeInUp" animateOut="fadeOut" animateOnce={true}>
                                    <Container className={"containerHeight" + (props.device === 'PC' ? " exContainerL" : "")}>
                                        <p className="font_7">
                                            {props.device === "PC" &&
                                                <svg id="1" xmlns="http://www.w3.org/2000/svg" version="1.1" className="point" style={{ right: '45px' }}>
                                                    <circle cx="5" cy="5" r="5" style={{ fill: '#d9c791' }} />
                                                </svg>
                                            }
                                            2019/09 - 2020/01
                                        ...
                                        <span className="description">軟體工程師</span>
                                        <br></br>
                                        <span className={props.device === "PC" ? "sp-Left" : "sp"}>
                                            小型專案，專案人數5人，擔任軟體工程師職位<br />
                        ...
                        <Row style={props.device !== "PC" ? {marginBottom : '5vh'} : null}>
                            <Col id="exp3" md={6} className={props.device === 'PC' ? "right" : ""}>
                                <ScrollAnimation animateIn="fadeInUp" animateOut="fadeOut" animateOnce={true}>
                                    <Container className={"containerHeight" + (props.device === 'PC' ? " exContainerR" : "")}>
                                        <p className="font_7">
                                            2020/01 - 現在
